...
#include "../pieces/Fugitive.hpp"
#include "../pieces/Helper.hpp"
#include "../pieces/Agent.hpp"
#include <fstream>
...
class Board {
	private:
		...
		std::vector<Move> getAllNonAgentMoves(bool);
	public:
		Board(); // constructor
		...
		bool determineDraw();
		bool determineFugitivePosition(bool);
