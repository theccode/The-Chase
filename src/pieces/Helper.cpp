...
// Helper class definition, defines the behavior of Helper pieces

/**
 * Helper constructor
 * @param c - the color of the piece
 */
Helper::Helper(bool c)
	: Piece(c, GameParams::H_VAL, 'H') {} // chain into base constructor

/**
 * explicit copy constructor
 * @return - a copy of this object
 */
std::shared_ptr<Piece> Helper::clone() const {
	return std::shared_ptr<Piece>(new Helper(*this));
}
 ...
 */
std::vector<Move> Helper::getMoves(Board* b, unsigned int c, unsigned int r) {
